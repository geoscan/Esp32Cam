...
void init()
{
	...
	static Ut::Sys::UartDevice devices[] = {
		Ut::Sys::UartDevice{UART_NUM_0, GPIO_NUM_3, GPIO_NUM_1, CONFIG_WIFI_UART_BRIDGE_BAUDRATE,
...
void start()
{
	...
	Ut::Thr::Config(true).core(0).stack(CONFIG_ESP32_PTHREAD_TASK_STACK_SIZE_DEFAULT);
